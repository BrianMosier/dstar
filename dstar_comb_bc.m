function [beta,lambda,c1,c2,dstar] = dstar_comb_bc(x1,x2,x3)
...
for i = 1:nmarkers
    [x1t(:,i),x2t(:,i),x3t(:,i),lambda(i)] = boxcox3d(x1(:,i),x2(:,i),x3(:,i));
end
...
cov1 = cov(x1t)*(n1-1)/n1;
cov2 = cov(x2t)*(n2-1)/n2;
cov3 = cov(x3t)*(n3-1)/n3;
...
[c_p1,dstar_p1]= fminsearchbnd(dist,[mean(mu1),mean(mu3),0],[-inf,-inf,-1],[inf,inf,1],options);
beta_p1 = [1 c_p1(3)];
...
dist = @(c) sqrt((1 -  normcdf(c(1),[-1 c(3)]*mu1',   sqrt([-1 c(3)]*cov1*[-1 c(3)]' )))^2 + ...
                 (1 - (normcdf(c(2),[-1 c(3)]*mu2',   sqrt([-1 c(3)]*cov2*[-1 c(3)]')) -  ...
                      ...
                      (normcdf(c(2),[-1 c(3)]*mu3',   sqrt([-1 c(3)]*cov3*[-1 c(3)]')))^2);
options = optimset('MaxIter',10000,'MaxFunEvals',10000,'TolX',1e-16);
[c_n1,dstar_n1]= fminsearchbnd(dist,[mean(mu1),mean(mu3),0],[-inf,-inf,-1],[inf,inf,1],options);
beta_n1 = [-1 c_n1(3)];
...
options = optimset('MaxIter',10000,'MaxFunEvals',10000,'TolX',1e-16);
[c_p2,dstar_p2]= fminsearchbnd(dist,[mean(mu1),mean(mu3),0],[-inf,-inf,-1],[inf,inf,1],options);
beta_p2 = [c_p2(3) 1];
...
dist = @(c) sqrt((1 -  normcdf(c(1),[c(3) -1]*mu1',   sqrt([c(3) -1]*cov1*[c(3) -1]' )))^2 + ...
                 (1 - (normcdf(c(2),[c(3) -1]*mu2',   sqrt([c(3) -1]*cov2*[c(3) -1]')) -  ...
                      ...
                      (normcdf(c(2),[c(3) -1]*mu3',   sqrt([c(3) -1]*cov3*[c(3) -1]')))^2);
options = optimset('MaxIter',10000,'MaxFunEvals',10000,'TolX',1e-16);
[c_n2,dstar_n2]= fminsearchbnd(dist,[mean(mu1),mean(mu3),0],[-inf,-inf,-1],[inf,inf,1],options);
beta_n2 = [c_n2(3) -1];
...
options = optimset('MaxIter',10000,'MaxFunEvals',10000,'TolX',1e-16);
[c_p1,dstar_p1]= fminsearchbnd(dist,[mean(mu1),mean(mu3),0,0],[-inf,-inf,-1,-1],[inf,inf,1,1],options);
...
dist = @(c) sqrt((1 -  normcdf(c(1),[-1 c(3) c(4)]*mu1',   sqrt([-1 c(3) c(4)]*cov1*[-1 c(3) c(4)]' )))^2 + ...
                 (1 - (normcdf(c(2),[-1 c(3) c(4)]*mu2',   sqrt([-1 c(3) c(4)]*cov2*[-1 c(3) c(4)]')) -  ...
                      ...
                      (normcdf(c(2),[-1 c(3) c(4)]*mu3',   sqrt([-1 c(3) c(4)]*cov3*[-1 c(3) c(4)]')))^2);
options = optimset('MaxIter',10000,'MaxFunEvals',10000,'TolX',1e-16);
[c_n1,dstar_n1]= fminsearchbnd(dist,[mean(mu1),mean(mu3),0,0],[-inf,-inf,-1,-1],[inf,inf,1,1],options);
...
options = optimset('MaxIter',10000,'MaxFunEvals',10000,'TolX',1e-16);
[c_p2,dstar_p2]= fminsearchbnd(dist,[mean(mu1),mean(mu3),0,0],[-inf,-inf,-1,-1],[inf,inf,1,1],options);
...
dist = @(c) sqrt((1 -  normcdf(c(1),[c(3) -1 c(4)]*mu1',   sqrt([c(3) -1 c(4)]*cov1*[c(3) -1 c(4)]' )))^2 + ...
                 (1 - (normcdf(c(2),[c(3) -1 c(4)]*mu2',   sqrt([c(3) -1 c(4)]*cov2*[c(3) -1 c(4)]')) -  ...
                      ...
                      (normcdf(c(2),[c(3) -1 c(4)]*mu3',   sqrt([c(3) -1 c(4)]*cov3*[c(3) -1 c(4)]')))^2);
options = optimset('MaxIter',10000,'MaxFunEvals',10000,'TolX',1e-16);
[c_n2,dstar_n2]= fminsearchbnd(dist,[mean(mu1),mean(mu3),0,0],[-inf,-inf,-1,-1],[inf,inf,1,1],options);
...
options = optimset('MaxIter',10000,'MaxFunEvals',10000,'TolX',1e-16);
[c_p3,dstar_p3]= fminsearchbnd(dist,[mean(mu1),mean(mu3),0,0],[-inf,-inf,-1,-1],[inf,inf,1,1],options);
...
dist = @(c) sqrt((1 -  normcdf(c(1),[c(3) c(4) -1]*mu1',   sqrt([c(3) c(4) -1]*cov1*[c(3) c(4) -1]' )))^2 + ...
                 (1 - (normcdf(c(2),[c(3) c(4) -1]*mu2',   sqrt([c(3) c(4) -1]*cov2*[c(3) c(4) -1]')) -  ...
                      ...
                      (normcdf(c(2),[c(3) c(4) -1]*mu3',   sqrt([c(3) c(4) -1]*cov3*[c(3) c(4) -1]')))^2);
options = optimset('MaxIter',10000,'MaxFunEvals',10000,'TolX',1e-16);
[c_n3,dstar_n3]= fminsearchbnd(dist,[mean(mu1),mean(mu3),0,0],[-inf,-inf,-1,-1],[inf,inf,1,1],options);
